...
import "../styles/ludocounter.scss";

const LudoCounterData = () => {
...
const tableStyles = {
  ...
  if (showUserData && selectedUser) {
    return <LudoCounterM user={selectedUser} handleClose={handleCloseUserData} />;
  }
...
export default LudoCounterData;